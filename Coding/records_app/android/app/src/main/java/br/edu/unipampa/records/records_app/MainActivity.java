package br.edu.unipampa.records.records_app;
...
import yuv_converter.yuvtransform.YuvConverter;
...
public class MainActivity extends FlutterActivity {
    ...
    private static final String CHANNEL = "records.yuv_transform/yuv";
